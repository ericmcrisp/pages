...
\textbf{Statistical Fact Verification System} \hfill Aug 2025 -- Present \\
...
$\bullet$ Building containerized production web application using Python, FastAPI, and Streamlit hosted on AWS and version controlld with CI\textbackslash CD. \\
