...
\renewcommand{\section}[2]%
        {\pagebreak[3]\vspace{0.8\baselineskip}%
...
\email{ecrisp@upenn.edu} & \hspace{42pt}\url{linkedin.com/in/ecrisp} \\ % & \url{ericmcrisp.github.io/pages}
(302) 528-2477 \\
\end{tabular}
...
\section{Summary}
I am seeking to transition into data science or AI/ML engineering, leveraging the engineering, analytical, and leadership experience I've developed throughout my career alongside the foundational AI/ML skills I built at Penn.
...
$\bullet$ Developed a full-stack restaurant recommendation application using PostgreSQL on AWS RDS, React frontend, Node.js backend with RESTful APIs, and NLTK for natural language processing. Implemented location-based search, similarity matching, and personalized recommendations with optimized SQL queries. \\
