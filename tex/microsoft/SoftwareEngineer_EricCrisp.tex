...
\section{Education}
  ...
  \-\quad \textbf{M.Sc., Data Science} % \hfill GPA: 3.5

  \blankline

  \textbf{Pennsylvania State University}, State College, PA
  \hfill Aug 2015 - May 2021 \\
  \-\quad \textbf{M.Sc., Mechanical Engineering} \\ % \hfill GPA: 3.9 \\
  \-\quad \textbf{B.Sc., Aerospace Engineering} % \hfill GPA: 3.4
...
\section{Technical Skills}
    ...
    \textbf{Frameworks} \\
    \verb|PyTorch, Scikit-learn, Pandas, Numpy| \\
    \verb|SQL, Spark, React, Node|
    \end{minipage}
    \begin{minipage}[t]{.25\textwidth}
    \textbf{Tools \& DevOps} \\
    \verb|Docker, AWS | \\
...
\section{Experience}
\textbf{Aerospace Engineer III, Real-Time Modeling}
...
$\bullet$ Served as RTM project manager from project conception by managing scope, deliverables, and delegation. \\
...
$\bullet$ Effectively communicated the value and impact of technical outcomes from RTM to both technical and non-technical steak-holders. \\
...
$\bullet$ Conducted root cause investigations of failures and implemented systematic and engineering solutions. \\ 
...
\textbf{Statistical Fact Verification System Web Application with RAG} \hfill Aug 2025 -- Present \\
$\bullet$ Developing full stack, end-to-end fact-checking system that integrates user queries with LLM outputs to estimate the likelihood that the output is true via comparison with trusted sources. \\
...
$\bullet$ Creating an NLP pipeline (spaCy, NLTK, Transformers) for claim detection, named entity recognition, and evidence-based verification from multiple sources (FEVER, Wikipedia API, and RAG).
$\bullet$ Built a containerized production web application using Python, FastAPI, and Streamlit hosted on AWS and version controlled with CI\textbackslash CD via GitHub Actions. \\

% \blankline

% \textbf{Physics-Informed Neural Network Approach to Parameter Estimation}
% \hfill Aug 2025 -- Present \\
% $\bullet$ Investigating the use of neural approaches to solve parameter estimation from systems of linear differential equations. \\
...
$\bullet$ Built an ML pipeline using scikit to classify food items and generate health scores using supervised learning algorithms with hyper-parameter tuning and model optimization achieving 91\% accuracy on test data. \\
$\bullet$ Implemented comprehensive data preprocessing using Pandas for large-scale dataset manipulation, NLTK for text processing and nutritional analysis, applied normalization, imputation, and encoding for PCA, and automated visualizations in postprocessing with Seaborn and Matplotlib.

\blankline

\textbf{Full Stack Restaurant Reccomendation System}
\hfill May 2025 -- Jun 2025 \\ 
$\bullet$ Built a full-stack application using AWS RDS, React, Node.js, SQL, PostgreSQL, and NLTK to create a series of recommendation systems to help users identify restaurants in their location, discover similar options, and receive personalized meal and restaurant suggestions. \\
...
\section{Awards and Activities}
  ...
  \hfill Jul 2022 \\
  Awarded for technical successes in developing the real-time modeling (RTM) capabilities at Blue Origin.
